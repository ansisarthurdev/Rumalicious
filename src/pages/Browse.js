...
const Browse = () => {
  ...
  return (
    <Wrapper>
      ...
      {loading ? <p style={{color: 'gray', marginTop: 20, fontSize: '1.2rem'}}>Searching...</p> : results?.length > 0 ? <p style={{color: 'gray', marginTop: 20, fontSize: '1.2rem'}}>Here is what we found,</p> : <p style={{color: 'gray', marginTop: 20, fontSize: '1.2rem'}}>What are you looking for?</p>}
